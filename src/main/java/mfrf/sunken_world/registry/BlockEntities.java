...
public class BlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<TileWaterProofFurnace>> WATER_PROOF_FURNACE_TILE = BLOCK_ENTITIES.register("water_proof_furnace", () -> BlockEntityType.Builder.of(TileWaterProofFurnace::new, Blocks.WATER_PROOF_FURNACE.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<TileWorldBeacon>> WORLD_BEACON_TILE = BLOCK_ENTITIES.register("overworld_beacon", () -> BlockEntityType.Builder.of(TileWorldBeacon::new, Blocks.WORLD_BEACON.block().get()).build(null));
