...
public class Entities {
    ...
    public static final RegistryObject<EntityType<WaterBlockProjectile>> WATER_BLOCK_PROJECTILE = ENTITIES.register("water_projectile", () -> EntityType.Builder.<WaterBlockProjectile>of(WaterBlockProjectile::new, MobCategory.MISC).sized(1f, 1f).clientTrackingRange(8).setShouldReceiveVelocityUpdates(true).updateInterval(2).build("water_projectile"));
    public static final RegistryObject<EntityType<UnderWaterTorch>> UNDERWATER_TORCH = ENTITIES.register("underwater_torch", () -> EntityType.Builder.<UnderWaterTorch>of(UnderWaterTorch::new, MobCategory.MISC).sized(1f, 1f).clientTrackingRange(8).setShouldReceiveVelocityUpdates(true).updateInterval(2).build("underwater_torch"));
}
