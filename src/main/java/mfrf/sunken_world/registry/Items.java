...
public class Items {
    ...
    public static final RegistryObject<Item> grace_of_ocean_pendant = ITEMS.register("grace_of_ocean_pendant", () -> new GracePendant(NON_STACK_NON_BREAK_PROPERTIES, Attributes.GRACE_OF_OCEAN.get()));
    public static final RegistryObject<Item> grace_of_sky_pendant = ITEMS.register("grace_of_sky_pendant", () -> new GracePendant(NON_STACK_NON_BREAK_PROPERTIES, Attributes.GRACE_OF_SKY.get()));
    public static final RegistryObject<Item> grace_of_strata_pendant = ITEMS.register("grace_of_strata_pendant", () -> new GracePendant(NON_STACK_NON_BREAK_PROPERTIES, Attributes.GRACE_OF_STRATA.get()));
